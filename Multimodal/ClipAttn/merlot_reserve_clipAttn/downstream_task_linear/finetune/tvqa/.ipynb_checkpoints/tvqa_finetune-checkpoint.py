...
##############
ckpt_dir = '/home/sakter/results/retrain/out_clip_tf_idf/base.yaml/'+ext
...
LOG = f"/home/sakter/results/retrain/finetune_clip_tf_idf/{ext}.log"    
...
epoch_elapsed = 0
best_acc = 0
early_stop = early_stopping.EarlyStopping(min_delta=1e-4, patience=2)
prev_step = 0
