...
config['data']['num_train_files'] = math.ceil((TOTAL_SIZE * PERCENT_DATASET) / (RECORD_PER_FILE*1.0))
...
##############
ckpt_dir = '/home/sakter/results/retrain/out_rerun/base.yaml/'+ext
...
LOG = f"/home/sakter/results/retrain/finetune/{ext}.log"    
...
# else:
params = load_checkpoint(config['_ckpt'])['params']
