...
def auto_auxiliary(args):
	...
	aux_dataOptions = DataOptions(args, tokenizer, tokenizer_bert, model_bert, autoloss_config.get_stage(0), autoloss_config.get_stage(-1), args.pretrained_mask_file_path)
	...
	wrapper_model = ModelWithAuxTasks(
										...
										save_path='/work/sakter/AANG/autoaux_outputs/TAPT/citation_intent/auxlr_tam_supervised/seed=0/modelWAuxTasks.pth',
...
def main():
	...
	parser.add_argument("--num_seed", type=int, default=5, help="Number of seeds to consider.")
	parser.add_argument(
		"--save_total_limit",
		type=int,
		default=None,
	...
	parser.add_argument("--has_alpha", action="store_true", help="Use alpha")
	...
	parser.add_argument("--mask_selection_process", type=str, default="max")
