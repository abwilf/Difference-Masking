...
#SBATCH --output=/work/sakter/AANG/logs/citation_intent_tf_idf_seed_5_mean.out # TODO
#SBATCH --error=/work/sakter/AANG/logs/citation_intent_tf_idf_seed_5_mean.err # TODO
