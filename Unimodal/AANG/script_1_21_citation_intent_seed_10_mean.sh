...
#SBATCH --output=/work/sakter/AANG/logs/citation_intent_tf_idf_seed_10_mean.out # TODO
#SBATCH --error=/work/sakter/AANG/logs/citation_intent_tf_idf_seed_10_mean.err # TODO
